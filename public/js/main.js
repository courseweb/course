...
.controller('TodoCtrl', function($scope, $state, $ionicSideMenuDelegate) {
    ...
    $scope.sendData = function(url, fd, cfunc) {
        $scope.xmlhttp.onreadystatechange = cfunc;
        $scope.xmlhttp.open("post", url, true);
        $scope.xmlhttp.send(fd);
    };
    ...
    $scope.personSubmit = function() {
        ...
        $scope.sendData("/index.php/index/Person/AddData", fd, function() {
